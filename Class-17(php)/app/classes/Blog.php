...
//        print_r($_FILES);
    ...
    public function getAllBlogs()
    {
        ...
        foreach ($this->array1 as $key=>$value)
        {
           ...
           if ($this->array2[0])
           {
               $this->array3[$key]['title'] = $this->array2[0];
               $this->array3[$key]['author_name'] = $this->array2[1];
               $this->array3[$key]['description'] = $this->array2[2];
               $this->array3[$key]['image'] = $this->array2[3];
           }
